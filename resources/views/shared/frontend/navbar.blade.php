<nav class="border-b border-gray-200">
    <div class="container mx-auto flex flex-wrap justify-between items-center ">
        ...
        <div class="hidden w-full lg:flex lg:w-auto menu">
            ...
            <button href="#" class="py-2 px-4 rounded-r-md bg-green-400 text-white focus:outline-none"><i class="fa fa-search"></i>&nbsp; 搜尋</button>
        </div>
        <div class="hidden w-full lg:flex lg:w-auto menu">
            <button href="#" class="py-2 px-4 mr-2 rounded bg-green-300 text-white focus:outline-none">註冊</button>
            <button href="#" class="py-2 px-4 rounded bg-gray-300 text-white focus:outline-none">登入</button>
        </div>
    </div>
</nav>